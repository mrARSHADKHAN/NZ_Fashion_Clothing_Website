            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="register_2.php" method="POST" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="user_id" class="form-control" id="yourEmail" required>
